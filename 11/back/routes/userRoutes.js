...
router.get('/me', getMe);
router.patch('/update-me', uploadUserAvatar, updateMe); // 1. update user data, 2. upload user avatar
...
router.route('/:id').get(getUserById).patch(checkUpdateUserData, updateUserById).delete(deleteUserById);
